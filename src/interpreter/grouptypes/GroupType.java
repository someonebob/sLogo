...
/**
 * A helper class used in the GroupStartUtil class in order to specify
 * implementation for different types of groupings (e.g., layered vs. multiple
 * commands)
 * 
 * @author maddiebriere
 *
...
public abstract class GroupType {
	 ...
	 * 
	 * Iterates through the list toModify until the limit is reached by removing
	 * the first item 'limit' times, and concatenating this item's command to
	 * the return value
	 * 
	 * @param limit
	 *            Number of times to remove the first item
	 * @param toModify
	 *            List of InstructionNodes to modify
	 * @param value
