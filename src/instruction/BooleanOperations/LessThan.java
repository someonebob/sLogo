 ...
 * first SLogo parameter is strictly less than the second. Returns 1 if so and 0
 * if not.
 * </p>
 * 
 * <p>
...
public class LessThan extends BooleanOperation {
	 ...
	 * doubleLessThan() for roundoff-safe equality checking and ternary
	 * statement for brevity. Assumptions: Correct number of SLogo arguments,
	 * numerically valued SLogo arguments. Dependencies: MathUtil's
	 * doubleLessThan(), Instruction's getArgumentDouble().
	 * 
